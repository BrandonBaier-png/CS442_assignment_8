...
#ifndef CS442_ASSIGNMENT_8_DYNAMIC_ARRAYS_H
#define CS442_ASSIGNMENT_8_DYNAMIC_ARRAYS_H

#include <iostream>
using namespace std;

/* Code pulled from GeeksForGeeks page "How do dynamic arrays work"
...
#endif //CS442_ASSIGNMENT_8_DYNAMIC_ARRAYS_H