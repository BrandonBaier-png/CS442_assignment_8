...
// clearing all vectors for the extra passes
void clearVectors() {
    matrixA.clear();
    matrixB.clear();
    matrixC.clear();
...
int main() {
    ...
    */
    ...
    /* following code was initially generated by ChatGPT,
     * using the prompt "write a c++ program that matrix multiplies a pair of dynamic arrays into a third"
     */
    vector<int> testMatrixes = {10, 25, 50, 75, 100, 250, 500};

    for (int i = 0; i < testMatrixes.size(); i++) {
        clearVectors();
        ...
        cout << testMatrixes[i] << " sized Thread" << endl;
        ...
        cout << "Parallel time in microseconds: " << duration.count() << endl<< endl;
